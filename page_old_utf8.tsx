...
/* ΓöÇΓöÇΓöÇ Animated Counter (reusable) ΓöÇΓöÇΓöÇ */
...
export default function LandingPage() {
  ...
  const features = [
    { icon: BookOpen, color: "emerald", title: "Authentic PYQ Vault", desc: "Every shift from CGL, CHSL, CPO, MTS & GD ΓÇö OCR-extracted, taxonomy-tagged, and ready for drill-mode practice.", hoverRotate: "-rotate-12" },
    { icon: BarChart3, color: "cyan", title: "AI-Powered Analytics", desc: "Pinpoint your exact weak topics, track accuracy trends over time, and get a personalized study roadmap ΓÇö no guesswork.", hoverRotate: "rotate-12" },
    ...
    { icon: Zap, color: "amber", title: "Mental Maths Arena", desc: "Timed calculation sprints with adaptive difficulty. Shave seconds off your per-question time ΓÇö the difference between selection and waitlist.", hoverRotate: "rotate-12" },
    { icon: Brain, color: "violet", title: "FSRS Smart Flashcards", desc: "The same spaced-repetition algorithm used by medical students ΓÇö applied to GK facts, idioms, and vocabulary you keep forgetting.", hoverRotate: "-rotate-6" },
    { icon: Gamepad2, color: "rose", title: "Gamified Retention", desc: "Crosswords, word-hunts, and contextual games that make static GK and vocabulary stick ΓÇö without the burnout of rote memorization.", hoverRotate: "-translate-y-1" },
  ];
  ...
  const timeline = [
    ...
    { icon: Map, color: "amber-500", ring: "amber-500", title: "Get Your AI Roadmap", desc: "The engine identifies your \"bleed topics\" ΓÇö where you haemorrhage marks or time ΓÇö and generates a prioritized daily study plan." },
    { icon: Dumbbell, color: "emerald-500", ring: "emerald-500", title: "Execute Daily Drills", desc: "20 targeted PYQs, 5 minutes of Mental Maths, and FSRS flashcard reviews ΓÇö every single day. Small, consistent inputs that compound." },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground overflow-x-hidden flex flex-col items-center relative scroll-smooth">
      ...
      {/* ΓöÇΓöÇΓöÇ Ambient Background ΓöÇΓöÇΓöÇ */}
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 pt-12 pb-16 md:pt-24 md:pb-28 flex flex-col items-center text-center relative z-10">
        ...
        >
          The only SSC prep platform built around AI analytics and spaced repetition ΓÇö not ads and chaos. CGL, CHSL, CPO, MTS, GD.
        </motion.p>
        ...
        >
          ...
          >
            Start Practicing ΓÇö Free <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </Link>
          <a 
            href="#how-it-works" 
        ...
        {/* ΓöÇΓöÇΓöÇ Trust Stats ΓöÇΓöÇΓöÇ */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }} 
          animate={{ opacity: 1, y: 0 }}
        ...
        {/* ΓöÇΓöÇΓöÇ Hero Dashboard Preview ΓöÇΓöÇΓöÇ */}
        <motion.div
      ...
      {/* ΓöÇΓöÇΓöÇ Competitor Comparison ΓöÇΓöÇΓöÇ */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-stretch">
            ...
            >
              ...
              <ul className="flex flex-col gap-3 sm:gap-3.5 text-foreground/70 text-sm sm:text-[15px]">
                {[
                  ...
                  "Feels like a chore ΓÇö zero motivation to open daily.",
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <span className="text-rose-500/80 font-bold mt-0.5 shrink-0">Γ£ò</span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            >
              ...
              <ul className="flex flex-col gap-3 sm:gap-3.5 text-foreground/90 font-medium text-sm sm:text-[15px]">
                {[
                  "Minimalist interface ΓÇö every pixel earns its place.",
            ...
            <div className="flex flex-col gap-10 md:gap-16 relative z-10">
              ...
              >
                ...
                <div className="md:w-1/2">
                  ...
                  <p className="text-foreground/60 leading-relaxed text-sm">The engine identifies your &quot;bleed topics&quot; ΓÇö where you haemorrhage marks or time ΓÇö and generates a prioritized daily study plan.</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="hidden md:block md:w-1/2 md:text-right">
                  ...
                  <p className="text-foreground/60 leading-relaxed text-sm">20 targeted PYQs, 5 minutes of Mental Maths, and FSRS flashcard reviews ΓÇö every single day. Small, consistent inputs that compound.</p>
                </div>
                {/* Icon */}
      ...
      {/* ΓöÇΓöÇΓöÇ Features Arsenal ΓöÇΓöÇΓöÇ */}
      <section className="w-full bg-card/10 border-y border-border/30 py-16 sm:py-24 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-foreground/60 text-sm sm:text-base md:text-lg max-w-2xl mx-auto font-normal leading-relaxed">
              Six deeply engineered tools ΓÇö each one designed to move a specific needle on exam day.
            </motion.p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              <div className="mb-8">
                ...
                <div className="mt-6 flex items-baseline gap-1">
                  <span className="text-4xl font-black text-foreground">Γé╣0</span>
            ...
            >
              ...
              <div className="mb-8">
                ...
                <div className="mt-6 flex items-baseline gap-1">
                  <span className="text-4xl font-black text-foreground">Γé╣99</span>
      ...
      <footer className="w-full bg-card/20 pt-16 sm:pt-24 pb-6 sm:pb-8 border-t border-border/20 relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-5 sm:pt-6 border-t border-border/30 flex flex-col md:flex-row items-center justify-between gap-3 text-center md:text-left">
          ...
          <div className="text-xs font-medium text-muted-foreground/60">
            Made with Γ¥ñ∩╕Å for students who refuse to settle.
          </div>
        </div>
      </footer>
