              ...
              {TAB_DATA.map((tab) => 
                activeTab === tab.id && (
                  <TabsContent key={tab.id} value={tab.id} className="mt-0 outline-none" asChild forceMount>
                    ...
                    >
                      {/* Subject Banner */}
                      <div className={`w-full rounded-3xl border bg-card/95 md:bg-card/60 backdrop-blur-none md:backdrop-blur-2xl ${tab.bgClass} p-5 sm:p-6 sm:px-7 flex flex-col sm:flex-row items-start sm:items-center gap-4 shadow-xl shadow-black/5 overflow-hidden relative`}>
